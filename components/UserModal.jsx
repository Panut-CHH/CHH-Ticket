...
export default function UserModal({ open, onClose, editingUser = null, onSuccess }) {
  ...
  const roleColors = {
    ...
    HR: "bg-slate-100 dark:bg-slate-800/30 text-slate-700 dark:text-slate-200 border-slate-200 dark:border-slate-700",
  };
            ...
            <form id="user-form" onSubmit={handleSubmit} className="p-4 sm:p-5 space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
                  {["SuperAdmin", "Admin", "HR", "QC", "Viewer", "Production", "Painting", "Supervisor Painting", "Supervisor Production", "Packing", "CNC", "Drawing", "Storage", "ProxyOperator"].map((role) => {
